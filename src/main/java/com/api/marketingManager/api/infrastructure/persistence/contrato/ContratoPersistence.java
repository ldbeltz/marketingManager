...
public class ContratoPersistence {
    ...
    public ContratoPersistence(Long idContrato, LocalDate dtaInicio, LocalDate dtaFim, float valorContrato, String desContrato, String cnpjContratante, int idTipoContrato) {
